...
// метода значение по умолчанию (null, 0, false, ...).
...
import ru.gb.SpringREST.demo.MyServiceBean;
...
//		System.out.println(myServiceBean.doSomething("arg1"));
//		System.out.println(myServiceBean.doSomething("foo"));
//		System.out.println(myServiceBean.doSomething("test"));
//		System.out.println(myServiceBean.doSomething2("arg2"));
	}
